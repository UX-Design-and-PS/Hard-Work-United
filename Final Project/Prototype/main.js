...
$(document).ready(function () {
    ...
    $('#search-nav').hover(
        function () {
            $('#search-nav a img').attr('src', "./Resources/search_hovered.PNG");
            $('#search-nav a').css('background-color', 'white');
        },
        function () {
            $('#search-nav a img').attr('src', "./Resources/search.PNG");
    ...
    $('#search-box-btn').hover(
        function () {
            $('#search-box-btn img').attr('src', './Resources/search_hovered.PNG');
        },
        function () {
            $('#search-box-btn img').attr('src', './Resources/search.PNG');
        }
    );
    ...
    $('#user-profile-nav').hover(
        function () {
            $('#user-profile-nav a img').attr('src', "./Resources/profile_hovered.PNG");
            $('#user-profile-nav a').css('background-color', 'white');
        },
        function () {
            $('#user-profile-nav a img').attr('src', "./Resources/profile.PNG");
    ...
    $('#user-profile-massages-nav').hover(
        function () {
            $('#user-profile-massages-nav a img').attr('src', "./Resources/notifications_hovered.PNG");
            $('#user-profile-massages-nav a').css('background-color', 'white');
        },
        function () {
            $('#user-profile-massages-nav a img').attr('src', "./Resources/notifications.PNG");
    ...
    $('#user-profile-massages-nav ul li div').hover(
        function () {
            $('#user-profile-massages-nav').attr('src', './Resources/notifications_hovered.PNG');
            $('#user-profile-massages-nav a').css('background-color', 'white');
        }
    );
